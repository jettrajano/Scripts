#####################################################################################
### Faz o move de um arquivo de origem em vários diretorios e com diversos nomes  ###
#####################################################################################
...
Import-Csv C:\Temp\Clientes\teste2.csv | % { Move-Item -Path "C:\Temp\Clientes\$($_.path)\$($_.file)" -Destination "C:\Temp\Clientes\copy" }
